			...
			if (po != null) {
				...
				try {
					...
					if (cupon != null) {
						...
						PartidaOnline partidaOnline = new PartidaOnline(sala, suscriptorAnfitrion, sesion,
								sala.getJugadoresMax(), idSala);
						...
						request.getRequestDispatcher("index.jsp?sec=organizar&codInvitacion=" + codInvitacion)
