...
-- Dumping data for table bilboskpdb.cupon: ~69 rows (approximately)
...
-- Dumping data for table bilboskpdb.escenario: ~10 rows (approximately)
...
-- Dumping data for table bilboskpdb.escenario_flecha: ~10 rows (approximately)
INSERT INTO `escenario_flecha` (`idObjeto`, `nombreEscenario`, `nombreEscenarioDestino`, `imagen`, `posicionX`, `posicionY`, `dimensionX`, `dimensionY`, `comentario`, `mensajeError`) VALUES
	...
	(1, 'MesaNave', 'PanelCodigo', 'izquierda', 85, 35, 8, 8, NULL, NULL);
...
-- Dumping data for table bilboskpdb.partidaonline: ~60 rows (approximately)
