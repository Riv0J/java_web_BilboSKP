		...
		<ul>
			<li><img src="../img_web/icons/directions.png" alt=""><span><a
				...
				<div id="mapa" style="display: none;">
					...
					<button
						onclick="document.getElementById('mapa').style.display='none'"><%=Traductor.getFrase("ENContactoBotonCerrar")%>
						</button>
				</div></li>
			<li><img src="../img_web/icons/llamada-telefonica.png" alt=""><%=Traductor.getFrase("ENContactoTelefono")%>:
				944BS7831</li>

		</ul>
	</div>
	<div class="caja redesSociales">
		<h2><%=Traductor.getFrase("ENContactoRedes")%></h2>
		<ul>
...
<div class="cajagrande">
	<div class="caja FAQ">
		<h2><%=Traductor.getFrase("ENContactoFAQ")%></h2>
		<ul class="acordeon">
			<li><a href='#'><%=Traductor.getFrase("ENContactoFAQ1")%></a>
				<ul>
					<li><%=Traductor.getFrase("ENContactoFAQ1R")%></li>
				</ul></li>
			<li><a href='#'><%=Traductor.getFrase("ENContactoFAQ2")%></a>
				<ul>
					<li><%=Traductor.getFrase("ENContactoFAQ2R")%></li>
				</ul></li>
			<li><a href='#'><%=Traductor.getFrase("ENContactoFAQ3")%></a>
				<ul>
					<li><%=Traductor.getFrase("ENContactoFAQ3R")%></li>
				</ul></li>
			<li><a href='#'><%=Traductor.getFrase("ENContactoFAQ4")%></a>
				<ul>
					<li><%=Traductor.getFrase("ENContactoFAQ4R")%></li>
				</ul></li>
			<li><a href='#'><%=Traductor.getFrase("ENContactoFAQ5")%></a>
				<ul>
					<li><%=Traductor.getFrase("ENContactoFAQ5R")%></li>

				</ul></li>
		</ul>
	</div>
	<div class="caja otrasConsultas">
		<h2><%=Traductor.getFrase("ENContactoOtras")%></h2>
		<ul>
			<li><p>
					<img src="../img_web/icons/parking.png" alt=""><span><a href="#"
						onclick="document.getElementById('mapaParking').style.display='block'"><%=Traductor.getFrase("ENContactoParking")%></a></span>
				</p>
				<div id="mapaParking" style="display: none">
					<iframe
						...
						loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					<button
						onclick="document.getElementById('mapaParking').style.display='none'"><%=Traductor.getFrase("ENContactoBotonCerrar")%></button>

				</div></li>
			<li><img src="../img_web/icons/metro.png" alt=""><span> <a href='#'
					onclick="document.getElementById('mapaMetro').style.display='block'"><%=Traductor.getFrase("ENContactoMetro")%></a></span>
				<div id="mapaMetro" style="display: none;">
					<iframe
						...
						loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					<button
						onclick="document.getElementById('mapaMetro').style.display='none'"><%=Traductor.getFrase("ENContactoBotonCerrar")%></button>
				</div></li>
		</ul>
	</div>
</div>
<div id="formulario">
	<h2>
		<%=Traductor.getFrase("ENContactoOtraConsulta")%><br>
	</h2>
	<form method="get">
		<textarea cols="60" rows="5" placeholder="<%=Traductor.getFrase("ENContactoTextarea")%>"></textarea>
		<br>
		<button name="submit" type="submit"><%=Traductor.getFrase("ENContactoEnviar")%></button>
		<button type="reset"><%=Traductor.getFrase("ENContactoBorrar")%></button>
