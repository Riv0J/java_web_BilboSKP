...
<body>
    ...
    <section id="escenario">
        ...
        <a id="salir" href="#" title="Quit/Salir"><i class="ri-logout-box-r-line"></i></i></a>  
			</div>
      <div id="menu_abajo" class="menu">
        ...
        <a id="botonInventario" title="Inventario" class="background-image_cuero"><i class="ri-red-packet-line"></i></a>
          ...
          <div class="caja_mensaje"><div class="caja_mensaje_emisor">Rivo:</div> <div class="caja_mensaje_texto"></div>Ola</div>
          <div class="caja_mensaje"><div class="caja_mensaje_emisor">Jose:</div> <div class="caja_mensaje_texto"></div>Ke</div>
          <div class="caja_mensaje"><div class="caja_mensaje_emisor">Sus:</div> <div class="caja_mensaje_texto"></div>Kien io?</div>
        </div>
        <div id="caja_inputs">
          <input type="text" id="mensaje" class="background_transparent" placeholder="Escribe un mensaje">
				  <button type="submit" class="i_boton background-image_cuero">
            <i class="ri-send-plane-fill"></i><div>Enviar</div>
          </button>
        </div>
			</form>
...
#escenario{
    background-image: url(<%=escenarioAMostrar.getImagen()%>);
    background-size: cover;
    height: 100%;
    position:absolute;
    z-index: -1;
